...
namespace DOWS_SmokeTest.com.DOWS_TestCases
{
    [TestFixture]
    class DOWS_Login_Test : TestBase
    {
        ...
        public void StartReport()
        {
            ...
            string reportPath = projectPath + "com.QA.Reports\\DOWS_Login_Test.html";
        ...
        public void GetResult()
        {
            ...
            {
                string screenshotPath = GetScreenshot.Capture(driver, "DOWS_Login_Test");
            ...
            if (status == TestStatus.Passed)
            {
                ...
                enew.Write(excelPath, "Two", 2, "Pass");
            }
            else if (status == TestStatus.Failed)
            {
                ...
                // var excelPath = @ConfigurationManager.AppSettings["ExcelData"];
                var excelPath = @inputExcelPath;
                enew.Write(excelPath, "Two", 2, "Fail");
            }
